...
72 | [@dmfrancisco](https://github.com/dmfrancisco)/[**escrito**](https://github.com/dmfrancisco/escrito) | Collaborative writing with Markdown & Textile | [:arrow_upper_right:](http://escrito.herokuapp.com/)
...
23 | [@Quicksaver](https://github.com/Quicksaver)/[**OmniSidebar**](https://github.com/Quicksaver/OmniSidebar) | A firefox add-on designed to provide more control over the behavior of the sidebar. | [:arrow_upper_right:](https://addons.mozilla.org/firefox/addon/omnisidebar/)
...
11 | [@callmephilip](https://github.com/callmephilip)/[**backbone-tyler**](https://github.com/callmephilip/backbone-tyler) | Composite views with backbone and handlebars.js |
...
8 | [@Couto](https://github.com/Couto)/[**Blueprint**](https://github.com/Couto/Blueprint) | Sugar syntax for Prototypal Inheritance |
...
5 | [@ricardofbarros](https://github.com/ricardofbarros)/[**battleship-game**](https://github.com/ricardofbarros/battleship-game) | Terminal battleship game |
...
3 | [@ramitos](https://github.com/ramitos)/[**csv-to-md**](https://github.com/ramitos/csv-to-md) |  |
...
3 | [@marcooliveira](https://github.com/marcooliveira)/[**webapp_boilerplate**](https://github.com/marcooliveira/webapp_boilerplate) | A simple boilerplate for quickly setting up a new app |
...
2 | [@fabriceleal](https://github.com/fabriceleal)/[**fabriceleal.github.c…**](https://github.com/fabriceleal/fabriceleal.github.com) | My personal web page... generated from source.fabriceleal.github.com | [:arrow_upper_right:](fabriceleal.github.com)
...
8 | [@Vazkii](https://github.com/Vazkii)/[**Neat**](https://github.com/Vazkii/Neat) | Functional minimalistic Unit Frames for the modern Minecrafter |
...
2 | [@Vazkii](https://github.com/Vazkii)/[**Layman-Mod-Maker**](https://github.com/Vazkii/Layman-Mod-Maker) |  | [:arrow_upper_right:](http://www.minecraftforum.net/topic/1475385-wip-layman-mod-maker-modding-has-never-been-as-simple/)
...
2 | [@saramgsilva](https://github.com/saramgsilva)/[**AzureMobileServices**](https://github.com/saramgsilva/AzureMobileServices) | Samples to help developers to use Azure Mobile Services. | [:arrow_upper_right:](http://saramgsilva.github.io/AzureMobileServices)
...
6 | [@dragonpt](https://github.com/dragonpt)/[**Kernel_3.4.67_KK_Wik…**](https://github.com/dragonpt/Kernel_3.4.67_KK_Wiko_DarkMoon) | Custom OpenSourced MTK KitKat Kernel 3.4.67+  (MT6582 SoC)  |
...
3 | [@smpb](https://github.com/smpb)/[**bootstrap-wiki**](https://github.com/smpb/bootstrap-wiki) | Simple wiki engine using Mojolicious and Bootstrap, with Markdown files as content. |
...
27 | [@ahilles107](https://github.com/ahilles107)/[**dashboard-widgets**](https://github.com/ahilles107/dashboard-widgets) | Dashboard Widgets system builded on top of Symfony components, Allow 3d party developer to build widets for your application dashboard. Each widgets can have controllers, views, entities, each widget must have repository and can be installed with Composer. |
...
3 | [@ahilles107](https://github.com/ahilles107)/[**content-performance-…**](https://github.com/ahilles107/content-performance-analytics) | Newsroom Content Analytics for journalists and editors. |
...
2 | [@ahilles107](https://github.com/ahilles107)/[**dashboard-widgets-da…**](https://github.com/ahilles107/dashboard-widgets-dashboard) | Sample working dashboard for dashboard-widgets system. See Dashboard Widgets in action.  |
...
107 | [@enen92](https://github.com/enen92)/[**program.plexus**](https://github.com/enen92/program.plexus) | (discontinued) |
66 | [@alcides](https://github.com/alcides)/[**pascal-in-python**](https://github.com/alcides/pascal-in-python) | Pascal compiler implemented in python using Lex, Yacc and LLVM |
59 | [@rcarmo](https://github.com/rcarmo)/[**rss2imap**](https://github.com/rcarmo/rss2imap) | An adaptation of rss2mail that uses IMAP directly |
54 | [@rcarmo](https://github.com/rcarmo)/[**Yaki**](https://github.com/rcarmo/Yaki) | A filesystem based wiki | [:arrow_upper_right:](http://the.taoofmac.com/space/projects/Yaki)
53 | [@rcarmo](https://github.com/rcarmo)/[**bottle-fever**](https://github.com/rcarmo/bottle-fever) | A clean-room clone of the Fever RSS aggregator, focusing on the API |
51 | [@rcarmo](https://github.com/rcarmo)/[**HJKLPlugin**](https://github.com/rcarmo/HJKLPlugin) | A plugin for using vim movement keys (HJKL) to navigate messages and message lists in Mac OS X Mail |
37 | [@rcarmo](https://github.com/rcarmo)/[**pngcanvas**](https://github.com/rcarmo/pngcanvas) | A minimalist library to render PNG images using pure Python |
33 | [@rcarmo](https://github.com/rcarmo)/[**imapbackup**](https://github.com/rcarmo/imapbackup) | A Python script for incremental backups of IMAP mailboxes | [:arrow_upper_right:](http://taoofmac.com/space/projects/imapbackup)
30 | [@rcarmo](https://github.com/rcarmo)/[**soup-strainer**](https://github.com/rcarmo/soup-strainer) | A reimplementation of the Readability/Decruft algorithm using BeautifulSoup and html5lib |
29 | [@imankulov](https://github.com/imankulov)/[**celery-api**](https://github.com/imankulov/celery-api) | Celery API discovery module |
21 | [@rcarmo](https://github.com/rcarmo)/[**piku**](https://github.com/rcarmo/piku) | The tiniest PaaS you've ever seen (for the Raspberry Pi, too!) |
19 | [@rcarmo](https://github.com/rcarmo)/[**ink-bottle**](https://github.com/rcarmo/ink-bottle) | A minimal skeleton for doing Bottle apps in a structured fashion (targeting Python 2.7 or above) |
18 | [@marado](https://github.com/marado)/[**stars-to-addresses**](https://github.com/marado/stars-to-addresses) | Get addresses from Google location stars |
18 | [@rcarmo](https://github.com/rcarmo)/[**python-utils**](https://github.com/rcarmo/python-utils) | A set of libraries I constantly re-use for a number of projects |
18 | [@alcides](https://github.com/alcides)/[**wallmanager**](https://github.com/alcides/wallmanager) | Website and Multitouch app to manage a Multi-Touch surface. | [:arrow_upper_right:](http://code.google.com/p/sensewall)
13 | [@imankulov](https://github.com/imankulov)/[**vqmetrics**](https://github.com/imankulov/vqmetrics) | Python functions to convert between different speech quality metrics |
11 | [@rcarmo](https://github.com/rcarmo)/[**transducers-py**](https://github.com/rcarmo/transducers-py) | A (discontinued) attempt at creating a Python transducer library, done as a weekend project |
11 | [@imankulov](https://github.com/imankulov)/[**speex-quality-evalua…**](https://github.com/imankulov/speex-quality-evaluation) | Source data, scripts and makefiles of the experiment for the Speex codec quality evaluation |
10 | [@rcarmo](https://github.com/rcarmo)/[**divmod.org**](https://github.com/rcarmo/divmod.org) | Archive of the old divmod.org SVN repo (snapshot from Launchpad) |
10 | [@enen92](https://github.com/enen92)/[**screensaver.atv4**](https://github.com/enen92/screensaver.atv4) | Apple aerial screensavers (apple tv 4) for Kodi |
10 | [@alcides](https://github.com/alcides)/[**tarpipe-python**](https://github.com/alcides/tarpipe-python) | Tarpipe API library in Python | [:arrow_upper_right:](http://wiki.alcidesfonseca.com)
8 | [@alcides](https://github.com/alcides)/[**alcides-bliki**](https://github.com/alcides/alcides-bliki) | My personal bliki | [:arrow_upper_right:](http://wiki.alcidesfonseca.com)
8 | [@dpgaspar](https://github.com/dpgaspar)/[**Flask-AppBuilder-Ske…**](https://github.com/dpgaspar/Flask-AppBuilder-Skeleton) | Skeleton application to use with Flask-AppBuilder (pip install flask-appbuilder) |
8 | [@enen92](https://github.com/enen92)/[**plugin.video.rtpplay**](https://github.com/enen92/plugin.video.rtpplay) | RTP Play Video Addon for KODI Entertainment Center |
8 | [@alcides](https://github.com/alcides)/[**django-layout**](https://github.com/alcides/django-layout) | My default Django folder structure | [:arrow_upper_right:](http://alcidesfonseca.com)
8 | [@alcides](https://github.com/alcides)/[**rdflib**](https://github.com/alcides/rdflib) | rdflib for Python, with SQLite fixes. | [:arrow_upper_right:](http://code.alcidesfonseca.com/docs/rdflib/)
7 | [@nmariz](https://github.com/nmariz)/[**xmlgenerator**](https://github.com/nmariz/xmlgenerator) | A simple python XML Generator |
6 | [@tnunes](https://github.com/tnunes)/[**codebits-talkgrabber**](https://github.com/tnunes/codebits-talkgrabber) | Download videos and presentations of Sapo Codebits Talks | [:arrow_upper_right:](https://codebits.eu/s/calendar)
6 | [@enen92](https://github.com/enen92)/[**script.module.thespo…**](https://github.com/enen92/script.module.thesportsdb) | Python module for thesportsdb.com |
5 | [@enen92](https://github.com/enen92)/[**script.tvlogo.downlo…**](https://github.com/enen92/script.tvlogo.downloader) | TVLogo Downloader program addon for Kodi |
5 | [@ticklemynausea](https://github.com/ticklemynausea)/[**mbot-shell**](https://github.com/ticklemynausea/mbot-shell) | Shell scripts for mbot's shell module |
5 | [@rcarmo](https://github.com/rcarmo)/[**vagrant-templates**](https://github.com/rcarmo/vagrant-templates) | Templates for Vagrant VMs with useful snippets |
5 | [@enen92](https://github.com/enen92)/[**script.sportscenter**](https://github.com/enen92/script.sportscenter) | kodi addon - WORK IN PROGRESS |
5 | [@imankulov](https://github.com/imankulov)/[**rpm-packages**](https://github.com/imankulov/rpm-packages) | Fresh specs for RHEL-based and RHED-derived distributions (CentOS, Amazon Linux AMI) |
4 | [@nunolourenco](https://github.com/nunolourenco)/[**Protein-Folding**](https://github.com/nunolourenco/Protein-Folding) | Evolutionary Computing Project |
4 | [@nmariz](https://github.com/nmariz)/[**restview**](https://github.com/nmariz/restview) | A Python module that makes it easy RESTful views in Django |
4 | [@imankulov](https://github.com/imankulov)/[**gsod**](https://github.com/imankulov/gsod) | Global Surface Summary of Day (GSOD) loader and parser |
4 | [@joaor](https://github.com/joaor)/[**pcompiler**](https://github.com/joaor/pcompiler) |  |
4 | [@enen92](https://github.com/enen92)/[**service.pvrtools**](https://github.com/enen92/service.pvrtools) | A simple addon to extend kodi iptv simple pvr addon |
3 | [@imankulov](https://github.com/imankulov)/[**django-project-stub**](https://github.com/imankulov/django-project-stub) | my own simple stub for Django projects |
3 | [@crsantos](https://github.com/crsantos)/[**EmentaSasuc-PyMT**](https://github.com/crsantos/EmentaSasuc-PyMT) | A simple url image retriever of sasuc’s canteens menu into a MTKineticList  of MTKineticImage |
3 | [@enen92](https://github.com/enen92)/[**service.sleeptimer**](https://github.com/enen92/service.sleeptimer) | A Kodi addon to automatically stop any streams playing for more than the time you specify. Useful if you have the habit to fall asleep while watching live content |
3 | [@tnunes](https://github.com/tnunes)/[**becas-python**](https://github.com/tnunes/becas-python) | becas API client for Python. | [:arrow_upper_right:](http://tnunes.github.io/becas-python/)
3 | [@rcarmo](https://github.com/rcarmo)/[**AirVideo**](https://github.com/rcarmo/AirVideo) | Python port of jphastings' excellent Ruby AirVideo client, enhanced with further functionality | [:arrow_upper_right:](http://the.taoofmac.com)
3 | [@dgomes](https://github.com/dgomes)/[**imap2rss**](https://github.com/dgomes/imap2rss) | Make an IMAP folder available through a RSS interface |
2 | [@imankulov](https://github.com/imankulov)/[**celery-watcher**](https://github.com/imankulov/celery-watcher) | Celery watcher application |
2 | [@imankulov](https://github.com/imankulov)/[**sex-server**](https://github.com/imankulov/sex-server) | SSH Execution server. Best variant for very lightweight pythonic RPC implementation.  |
2 | [@imankulov](https://github.com/imankulov)/[**sex-client**](https://github.com/imankulov/sex-client) | SSH Execution client. Best variant for very lightweight pythonic RPC implementation.  |
2 | [@lidiamcfreitas](https://github.com/lidiamcfreitas)/[**SimulatorPopulationP…**](https://github.com/lidiamcfreitas/SimulatorPopulationProtocols) | This project is a simulator of population protocols to test abstract and theoretical algorithms related to populations.  |
2 | [@imankulov](https://github.com/imankulov)/[**autobuilder**](https://github.com/imankulov/autobuilder) | Automatically builds repo snapshots with git-buildpackage |
2 | [@marado](https://github.com/marado)/[**tweet_dumper**](https://github.com/marado/tweet_dumper) | A tool to retrieve all possible tweets from an user |
2 | [@marado](https://github.com/marado)/[**hattai-fortune**](https://github.com/marado/hattai-fortune) | Hattai's Fortune: a script that gives news |
2 | [@andrefreitas](https://github.com/andrefreitas)/[**rocketchat-nagios**](https://github.com/andrefreitas/rocketchat-nagios) | Sends Nagios notifications to Rocket.Chat, an Open Source Slack Alternative |
2 | [@andrefreitas](https://github.com/andrefreitas)/[**blacklist-serverdens…**](https://github.com/andrefreitas/blacklist-serverdensity-plugin) | This is a plugin for Server Density monitoring software to check if the Server IPs are in Email Blacklists |
2 | [@dpgaspar](https://github.com/dpgaspar)/[**flask-babelPkg**](https://github.com/dpgaspar/flask-babelPkg) | i18n and l10n support for Flask based on Babel and pytz. Support for package development, merging translations |
2 | [@imankulov](https://github.com/imankulov)/[**trytry**](https://github.com/imankulov/trytry) | A framework for "try-whatever" web services |
2 | [@joaor](https://github.com/joaor)/[**Event_Semantic**](https://github.com/joaor/Event_Semantic) | Projecto da cadeira de Web Semantica |
2 | [@imankulov](https://github.com/imankulov)/[**gevent-websocket**](https://github.com/imankulov/gevent-websocket) | Mirror of the bitbucket repo, made for the sake of building deb packages | [:arrow_upper_right:](https://bitbucket.org/Jeffrey/gevent-websocket)
2 | [@crsantos](https://github.com/crsantos)/[**Chameleon**](https://github.com/crsantos/Chameleon) | A chameleon' style feed reader |
2 | [@imankulov](https://github.com/imankulov)/[**google-api**](https://github.com/imankulov/google-api) | Simple Django app demonstrating various usage scenarios of Google authentication mechanisms |
2 | [@rlafuente](https://github.com/rlafuente)/[**isocraft**](https://github.com/rlafuente/isocraft) | Make isometric vector art from Minecraft constructions |
...
332 | [@methodmissing](https://github.com/methodmissing)/[**scrooge**](https://github.com/methodmissing/scrooge) | Fetch exactly what you need |
168 | [@rubenfonseca](https://github.com/rubenfonseca)/[**twitter-amqp-websock…**](https://github.com/rubenfonseca/twitter-amqp-websocket-example) | Simple example of Twitter + AMQP + RabbitMQ + EventMachine + HTML5 WebSocket with no polling | [:arrow_upper_right:](http://blog.0x82.com/2009/12/28/twitter-amqp-websocket-example-no-polling)
61 | [@methodmissing](https://github.com/methodmissing)/[**mysqlplus_adapter**](https://github.com/methodmissing/mysqlplus_adapter) |  |
53 | [@rfelix](https://github.com/rfelix)/[**my_jekyll_extensions**](https://github.com/rfelix/my_jekyll_extensions) | Portable Jekyll extensions I use for my website (to be used with jekyll_ext) | [:arrow_upper_right:](http://rfelix.com/2010/01/19/jekyll-extensions-minus-equal-pain/)
49 | [@rfelix](https://github.com/rfelix)/[**jekyll_ext**](https://github.com/rfelix/jekyll_ext) | My attempt to make Jekyll more extendable and to make extensions portable | [:arrow_upper_right:](http://rfelix.com/2010/01/19/jekyll-extensions-minus-equal-pain/)
45 | [@webcracy](https://github.com/webcracy)/[**activity_streams**](https://github.com/webcracy/activity_streams) | Ruby Activity Streams Parser | [:arrow_upper_right:](http://0x82.com)
43 | [@methodmissing](https://github.com/methodmissing)/[**mri_instrumentation**](https://github.com/methodmissing/mri_instrumentation) | dtrace pid provider hooks for mri |
41 | [@goncalossilva](https://github.com/goncalossilva)/[**gem_template**](https://github.com/goncalossilva/gem_template) | A skeleton gem |
35 | [@methodmissing](https://github.com/methodmissing)/[**hwia**](https://github.com/methodmissing/hwia) | Native MRI HashWithIndifferentAccess implementation | [:arrow_upper_right:](http://blog.methodmssing.com)
31 | [@rubenfonseca](https://github.com/rubenfonseca)/[**motion-bt-low-energy…**](https://github.com/rubenfonseca/motion-bt-low-energy-example) | Simple example of using Bluetooth LE with RubyMotion to connect to a Heart Rate monitor |
30 | [@rikas](https://github.com/rikas)/[**slack-poster**](https://github.com/rikas/slack-poster) | Simple gem to post messages on Slack using web hooks. |
27 | [@methodmissing](https://github.com/methodmissing)/[**aftermath**](https://github.com/methodmissing/aftermath) | An example CQRS implementation in the Ruby language | [:arrow_upper_right:](http://github.com/methodmissing/aftermath)
24 | [@david](https://github.com/david)/[**merb_cucumber**](https://github.com/david/merb_cucumber) | Merb + Cucumber integration |
22 | [@webcracy](https://github.com/webcracy)/[**motion-sparkle**](https://github.com/webcracy/motion-sparkle) | motion-sparkle makes it easy to use Sparkle in your RubyMotion OS X apps |
21 | [@sdsantos](https://github.com/sdsantos)/[**sinatra-mongoid-app**](https://github.com/sdsantos/sinatra-mongoid-app) | A template application for setting up Sinatra with Mongoid (Heroku ready). |
20 | [@methodmissing](https://github.com/methodmissing)/[**cb**](https://github.com/methodmissing/cb) | Native MRI callback | [:arrow_upper_right:](http://blog.methodmissing.com)
19 | [@goncalossilva](https://github.com/goncalossilva)/[**mongoid-sequence**](https://github.com/goncalossilva/mongoid-sequence) | Specify fields to behave like a sequence number (exactly like the "id" column in conventional SQL flavors) while using Mongoid. |
16 | [@goncalossilva](https://github.com/goncalossilva)/[**XAccelRedirect**](https://github.com/goncalossilva/XAccelRedirect) | A Ruby on Rails plugin for X-Accel-Redirect support (the nginx equivalent of X-Sendfile) |
15 | [@locks](https://github.com/locks)/[**halibut**](https://github.com/locks/halibut) | tools to handle the HAL specification | [:arrow_upper_right:](http://locks.github.com/halibut)
14 | [@methodmissing](https://github.com/methodmissing)/[**promise**](https://github.com/methodmissing/promise) | Lightweight Ruby MRI promise extension | [:arrow_upper_right:](http://blog.methodmissing.com)
14 | [@goncalossilva](https://github.com/goncalossilva)/[**alfred2-android_sdk_…**](https://github.com/goncalossilva/alfred2-android_sdk_reference_search-workflow) | Alfred workflow for searching the Android SDK class and XML references. |
13 | [@guilhermesimoes](https://github.com/guilhermesimoes)/[**omniauth-popup**](https://github.com/guilhermesimoes/omniauth-popup) | Pure OmniAuth login with a popup window | [:arrow_upper_right:](http://omniauth-popup.herokuapp.com/)
12 | [@goncalossilva](https://github.com/goncalossilva)/[**dummy**](https://github.com/goncalossilva/dummy) | A Ruby library to generate clever dummy data. |
12 | [@goncalossilva](https://github.com/goncalossilva)/[**dummy_data**](https://github.com/goncalossilva/dummy_data) | Uses dummy to generate consistent fake data for your models (including associations) and provides a rake task to import it into the database. |
11 | [@rfelix](https://github.com/rfelix)/[**hostgitrb**](https://github.com/rfelix/hostgitrb) | Simple Git repository hosting using SSH Public Keys | [:arrow_upper_right:](rfelix.com/2010/04/06/git-repo-hosting-via-ssh)
11 | [@methodmissing](https://github.com/methodmissing)/[**routing_with_optiona…**](https://github.com/methodmissing/routing_with_optional_formats) | Selectively enable or disable formatted named routes being generated |
10 | [@rikas](https://github.com/rikas)/[**iosdevices**](https://github.com/rikas/iosdevices) | iOS device model translation from Apple device types. |
10 | [@methodmissing](https://github.com/methodmissing)/[**memcached_store**](https://github.com/methodmissing/memcached_store) | ActiveSupport Cache Store for http://github.com/fauna/memcached/tree/m…  |
9 | [@zamith](https://github.com/zamith)/[**github-nice-guy**](https://github.com/zamith/github-nice-guy) |  |
8 | [@diogomonica](https://github.com/diogomonica)/[**sinatra_geoip**](https://github.com/diogomonica/sinatra_geoip) | Simple IP Geolocation endpoint deployable to heroku |
8 | [@methodmissing](https://github.com/methodmissing)/[**erubis_template_hand…**](https://github.com/methodmissing/erubis_template_handler) | Rails 2.3 / Edge template handler for erubis ( http://www.kuwata-lab.com/erubis/ ) |
7 | [@rikas](https://github.com/rikas)/[**ios_on_rails**](https://github.com/rikas/ios_on_rails) | iOS on Rails workshop |
7 | [@goncalossilva](https://github.com/goncalossilva)/[**rails_performance_ci**](https://github.com/goncalossilva/rails_performance_ci) | Rails application for a performance-oriented continuous integration of Ruby on Rails |
7 | [@zamith](https://github.com/zamith)/[**mechanic**](https://github.com/zamith/mechanic) | Makes your engines better. |
7 | [@josemotanet](https://github.com/josemotanet)/[**rest-apis-with-grape**](https://github.com/josemotanet/rest-apis-with-grape) | Sample file uploader application using Grape, Sequel and Carrierwave. |
7 | [@rubenfonseca](https://github.com/rubenfonseca)/[**tarpipe-ruby**](https://github.com/rubenfonseca/tarpipe-ruby) | Ruby bridge to tarpipe.com's REST API | [:arrow_upper_right:](http://tarpipe.rubyforge.org)
7 | [@webcracy](https://github.com/webcracy)/[**computerbot**](https://github.com/webcracy/computerbot) | A Ruby XMPP framework for modular bot creation; a CLI to your social cloud data. | [:arrow_upper_right:](http://computer.webcracy.org/)
7 | [@goncalossilva](https://github.com/goncalossilva)/[**Scaling-Rails**](https://github.com/goncalossilva/Scaling-Rails) | Master thesis about Rails scalability and performance optimization | [:arrow_upper_right:](http://snaprails.tumblr.com)
7 | [@webcracy](https://github.com/webcracy)/[**computer-bot--twitte…**](https://github.com/webcracy/computer-bot--twitter-edition) | A full-featured Twitter IM bot using the Computer bot framework. | [:arrow_upper_right:](http://computer.webcracy.org/twitteredition)
6 | [@josemotanet](https://github.com/josemotanet)/[**rails_store_with_bra…**](https://github.com/josemotanet/rails_store_with_braintree) | Source code for the Tuts+ course: Build a Store with Payment Gateway and Rails. |
6 | [@rfelix](https://github.com/rfelix)/[**iwannareadit**](https://github.com/rfelix/iwannareadit) | Web app to manage book suggestions, voting, and lending | [:arrow_upper_right:](http://iwannareadit.heroku.com)
6 | [@diogomonica](https://github.com/diogomonica)/[**urbanspooner**](https://github.com/diogomonica/urbanspooner) | Urban Spoon Reservation Bot |
6 | [@dnlserrano](https://github.com/dnlserrano)/[**simple_authenticatio…**](https://github.com/dnlserrano/simple_authentication_token_sample_app) | Simple greetings app to showcase the use of the simple_authentication_token gem |
5 | [@methodmissing](https://github.com/methodmissing)/[**railswaycon_imr_shor…**](https://github.com/methodmissing/railswaycon_imr_shorttalk) | Inside Matz Ruby lightning type talk | [:arrow_upper_right:](http://www.railswaycon.com)
5 | [@methodmissing](https://github.com/methodmissing)/[**rb_darkstar_server**](https://github.com/methodmissing/rb_darkstar_server) | JRuby wrapper for the Project Darkstar Server component | [:arrow_upper_right:](http://www.projectdarkstar.com)
4 | [@dnlserrano](https://github.com/dnlserrano)/[**mongoid-bigbang**](https://github.com/dnlserrano/mongoid-bigbang) | Mock creation timestamps of MongoDB objects using their ObjectId |
4 | [@rikas](https://github.com/rikas)/[**portuguese_validator…**](https://github.com/rikas/portuguese_validators) | This is a simple gem to validate NIB, NIF, BI and phone numbers. |
4 | [@zamith](https://github.com/zamith)/[**cohive-core**](https://github.com/zamith/cohive-core) |  |
4 | [@jsvd](https://github.com/jsvd)/[**blackboard**](https://github.com/jsvd/blackboard) | a layer over moneta for hierarchical storage |
4 | [@rubenfonseca](https://github.com/rubenfonseca)/[**sinatra-capistrano-w…**](https://github.com/rubenfonseca/sinatra-capistrano-workshop) | Code written during the Sinatra and Capistrano workshop at 06/03/2009, in Lisbon | [:arrow_upper_right:](http://startu.tumblr.com/post/83200299/mini-workshop-sinatra-e-capistrano)
4 | [@methodmissing](https://github.com/methodmissing)/[**railswaycon_events**](https://github.com/methodmissing/railswaycon_events) | Embracing Events | [:arrow_upper_right:](http://www.railswaycon.com)
4 | [@brunohq](https://github.com/brunohq)/[**go2dir**](https://github.com/brunohq/go2dir) | go2dir is a shorcut manager to speed up your command line cding |
3 | [@rubenfonseca](https://github.com/rubenfonseca)/[**musicbox**](https://github.com/rubenfonseca/musicbox) | workshop and fun experiment to access SAPO's MusicBox service as an API | [:arrow_upper_right:](http://musicbox.sapo.pt)
3 | [@jsvd](https://github.com/jsvd)/[**bank-stats**](https://github.com/jsvd/bank-stats) | Collect data of last bank transactions, tag them and represent them. |
3 | [@david](https://github.com/david)/[**dm-is-revisioned**](https://github.com/david/dm-is-revisioned) | DataMapper versioning plugin which is a bit more flexible than dm-is-versioned |
3 | [@rubenfonseca](https://github.com/rubenfonseca)/[**whitme**](https://github.com/rubenfonseca/whitme) | Ruby library for the URL shortener service whit.me | [:arrow_upper_right:](http://www.whit.me/api/docs)
3 | [@dnlserrano](https://github.com/dnlserrano)/[**token_auth_sample_ap…**](https://github.com/dnlserrano/token_auth_sample_app) | An alternative to using the simple_authentication_token gem |
3 | [@guilhermesimoes](https://github.com/guilhermesimoes)/[**rails_alacarte_serve…**](https://github.com/guilhermesimoes/rails_alacarte_server) | Rails API for mobile applications. |
3 | [@josemotanet](https://github.com/josemotanet)/[**ruby-refactoring**](https://github.com/josemotanet/ruby-refactoring) | Refactoring examples in Ruby. |
3 | [@fredoliveira](https://github.com/fredoliveira)/[**taskbot**](https://github.com/fredoliveira/taskbot) | Taskbot is a xmpp/redis-based tasklist management bot |
3 | [@rikas](https://github.com/rikas)/[**deeplink**](https://github.com/rikas/deeplink) | Gem to manage deep links parsing. |
3 | [@rikas](https://github.com/rikas)/[**app_store_info**](https://github.com/rikas/app_store_info) | Apple App Store parser — Get information about iOS apps |
3 | [@methodmissing](https://github.com/methodmissing)/[**stable_session_id**](https://github.com/methodmissing/stable_session_id) | Stable Session Identifier support for Cookie Session Store |
2 | [@rikas](https://github.com/rikas)/[**enei**](https://github.com/rikas/enei) | Workshop ENEI 2004 |
2 | [@guilhermesimoes](https://github.com/guilhermesimoes)/[**chrome-bug**](https://github.com/guilhermesimoes/chrome-bug) | A bug caused by a browser's aggressive caching and a Vary header not being sent | [:arrow_upper_right:](http://secret-journey-4942.herokuapp.com/)
2 | [@zamith](https://github.com/zamith)/[**fake-paymill**](https://github.com/zamith/fake-paymill) | A Paymill fake so that you can avoid hitting Paymill's servers in tests |
2 | [@zamith](https://github.com/zamith)/[**Cloudinha-Lock-Manag…**](https://github.com/zamith/Cloudinha-Lock-Manager) |  |
2 | [@david](https://github.com/david)/[**logbot**](https://github.com/david/logbot) | A logging bot for IRC |
2 | [@webcracy](https://github.com/webcracy)/[**shift2010_twitter_ar…**](https://github.com/webcracy/shift2010_twitter_archive) | SHiFT Conf 2010 Twitter buzz archive | [:arrow_upper_right:](http://2010.shift.pt)
2 | [@rubenfonseca](https://github.com/rubenfonseca)/[**twitter_auth-with-co…**](https://github.com/rubenfonseca/twitter_auth-with-couchdb) | Twitter Auth, CouchDB flavor |
2 | [@jsvd](https://github.com/jsvd)/[**logstash-filter-geoc…**](https://github.com/jsvd/logstash-filter-geocoder) | Logstash filter that converts strings (addresses) into coordinates using geocoder gem |
2 | [@jsvd](https://github.com/jsvd)/[**sequel_vectorized**](https://github.com/jsvd/sequel_vectorized) | Allows Sequel::Dataset to be exported as an Hash of Arrays and NArrays (http://narray.rubyforge.org) |
2 | [@rubenfonseca](https://github.com/rubenfonseca)/[**puny**](https://github.com/rubenfonseca/puny) | Ruby library for the URL shortener service created by SAPO | [:arrow_upper_right:](http://services.sapo.pt/Metadata/Service/PunyURL?culture=EN)
2 | [@locks](https://github.com/locks)/[**arqsi-soap-client**](https://github.com/locks/arqsi-soap-client) | cliente soap para o trabalho prático de ARQSI | [:arrow_upper_right:](https://github.com/locks/arqsi-soap-client)
2 | [@rubenfonseca](https://github.com/rubenfonseca)/[**newzbin_xmpp**](https://github.com/rubenfonseca/newzbin_xmpp) | Ruby XMPP agent to search the newzbin.com website | [:arrow_upper_right:](http://www.newzbin.com)
2 | [@locks](https://github.com/locks)/[**silliness**](https://github.com/locks/silliness) | random silliness | [:arrow_upper_right:](http://vimeo.com/19193286)
2 | [@goncalossilva](https://github.com/goncalossilva)/[**deep_copy**](https://github.com/goncalossilva/deep_copy) | Deep copy for Active Record objects |
2 | [@locks](https://github.com/locks)/[**project_euler**](https://github.com/locks/project_euler) | yeah, I'll make some stuff as I go along | [:arrow_upper_right:](http://projecteuler.net/index.php?section=profile&profile=locks)
2 | [@josemotanet](https://github.com/josemotanet)/[**tutsplus-dockerapp**](https://github.com/josemotanet/tutsplus-dockerapp) | Source code for the "Deploy a Rails Application with Docker" course. |
2 | [@goncalossilva](https://github.com/goncalossilva)/[**code2gist**](https://github.com/goncalossilva/code2gist) | Parse text files (markdown/textile/whatever) for code blocks and gist them |
...
36 | [@kintoandar](https://github.com/kintoandar)/[**git-hooks**](https://github.com/kintoandar/git-hooks) | github_email_verify: Avoid committing to github with your corporate email |
8 | [@celso](https://github.com/celso)/[**arcade**](https://github.com/celso/arcade) | Scripts and Patches for Arcade Machine System |
7 | [@kintoandar](https://github.com/kintoandar)/[**shell_scripts**](https://github.com/kintoandar/shell_scripts) | Several shell scripts organized by function: init script to manage multiple Ghost blog instances + backup to an encrypted tar.gz file using gpg + iptables template + ssh vpn + nagios/nrpe/sensu script for monitoring dmraid, modsecurity, ossec + plugin for IRSSI email on mentions | [:arrow_upper_right:](https://blog.kintoandar.com/)
6 | [@SandroMachado](https://github.com/SandroMachado)/[**xcassetsutils**](https://github.com/SandroMachado/xcassetsutils) | Shell Scripts to extract and restore all the images in an Asset Catalog folder (.xcassets) |
5 | [@marmelo](https://github.com/marmelo)/[**streaming-pt**](https://github.com/marmelo/streaming-pt) | Live TV and Radio shell scripts from Portugal. |
3 | [@cenourinha](https://github.com/cenourinha)/[**webtuga-gameserver-s…**](https://github.com/cenourinha/webtuga-gameserver-script-management) | A Linux Bash script that will help you to create and manage gameservers. Great tool for the one's who don't like to remember all that Linux commands that are too confuse for your brain. | [:arrow_upper_right:](http://www.webtuga.com)
3 | [@miuiportugal](https://github.com/miuiportugal)/[**IdeosX5-U8800-Port**](https://github.com/miuiportugal/IdeosX5-U8800-Port) |  | [:arrow_upper_right:](www.miui-pt.com)
